...
export declare function getTransactionGasPrice(tx: SuiTransactionBlockResponse): number | undefined;
export declare function getTransactionGasBudget(tx: SuiTransactionBlockResponse): number | undefined;
...
export declare function getTimestampFromTransactionResponse(data: SuiTransactionBlockResponse): number | undefined;
/**
